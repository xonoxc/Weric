...
export interface FeedControllerShape {
  readonly generate: (
    c: HonoCtx<{ Variables: ApiVariables }>
  ) => Effect.Effect<Response, unknown>
}

export class FeedController extends Effect.Service<FeedControllerShape>()(
  "FeedController",
  {
    effect: Effect.gen(function* () {
      ...
      } satisfies FeedControllerShape
    }),
  }
) {}

export const FeedControllerLive = FeedController.Default
